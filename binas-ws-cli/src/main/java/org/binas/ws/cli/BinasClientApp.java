...
public class BinasClientApp {
    ...
    public static void main(String[] args) throws Exception {
        ...
        //CASO F1
        client.activateUser("aaa@gmail.com");
        client.activateUser("bbb@gmail.com");  
        client.activateUser("ccc@gmail.com"); 
        client.rentBina("T41_Station1", "aaa@gmail.com");
        client.rentBina("T41_Station2", "bbb@gmail.com");
        client.rentBina("T41_Station3", "ccc@gmail.com");
        client.returnBina("T41_Station2", "aaa@gmail.com");
        client.returnBina("T41_Station3","bbb@gmail.com" );
        client.returnBina("T41_Station1","ccc@gmail.com" );
        
        //CASO F2
//        client.rentBina("T41_Station1","aaa@gmail.com");
//        client.returnBina("T41_Station1","aaa@gmail.com");
